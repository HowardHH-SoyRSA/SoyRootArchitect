...
def _variant(
    ...
    *,
    ...
    if trace_family is not None:
        path.score_components["trace_parameter_family"] = float(trace_family)
    return path
...
def test_correlated_beam_siblings_count_as_one_parameter_family() -> None:
    candidates = [
        _variant(
            "east-h1",
            (1.00, 0.00, 0.0),
