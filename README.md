# SoyRootArchitect / SoyRootBio 0.2
...
```powershell
git clone https://github.com/HowardHH-SoyRSA/SoyRootArchitect.git
cd SoyRootArchitect
python -m venv .venv
...
Real-root mesh datasets are not included in this repository. Use locally
authorized STL or PLY files as inputs. The small synthetic dataset under
`data/synthetic/` remains available for smoke tests.
